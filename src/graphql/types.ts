...
export type CurrentUserFieldsFragment = { readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } };

export type PlaylistFieldsFragment = { readonly id: string, readonly name: string, readonly description: string, readonly publicType: PlaylistPublicTypeEnum, readonly isMine?: Maybe<boolean>, readonly createdAt: string, readonly updatedAt: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly items: ReadonlyArray<{ readonly trackNumber: number, readonly track: { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> } }> };

export type RadioFieldsFragment = { readonly id: string, readonly name: string, readonly description: string, readonly startDatetime?: Maybe<string>, readonly trackNumber: number, readonly durationMs: number, readonly isMine?: Maybe<boolean>, readonly tracks: ReadonlyArray<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> };

export type TrackFieldsFragment = { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> };
...
export type AddPlaylistItemsMutation = { readonly addPlaylistItems?: Maybe<{ readonly playlist?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly publicType: PlaylistPublicTypeEnum, readonly isMine?: Maybe<boolean>, readonly createdAt: string, readonly updatedAt: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly items: ReadonlyArray<{ readonly trackNumber: number, readonly track: { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> } }> }> }> };
...
export type ChangeFavoritesMutation = { readonly changeFavorites?: Maybe<{ readonly currentUser?: Maybe<{ readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } }> }> };
...
export type CreateRadioMutation = { readonly createRadio?: Maybe<{ readonly radio?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly startDatetime?: Maybe<string>, readonly trackNumber: number, readonly durationMs: number, readonly isMine?: Maybe<boolean>, readonly tracks: ReadonlyArray<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> }> }> };
...
export type DeletePlaylistMutation = { readonly deletePlaylist?: Maybe<{ readonly result?: Maybe<string> }> };
...
export type DeleteRadioMutation = { readonly deleteRadio?: Maybe<{ readonly playlist?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly publicType: PlaylistPublicTypeEnum, readonly isMine?: Maybe<boolean>, readonly createdAt: string, readonly updatedAt: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly items: ReadonlyArray<{ readonly trackNumber: number, readonly track: { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> } }> }> }> };
...
export type LoginMutation = { readonly login?: Maybe<{ readonly currentUser?: Maybe<{ readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } }> }> };
...
export type LogoutMutation = { readonly logout?: Maybe<{ readonly currentUser?: Maybe<{ readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } }> }> };
...
export type SignupMutation = { readonly signup?: Maybe<{ readonly currentUser?: Maybe<{ readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } }> }> };
...
export type UpdateMeMutation = { readonly updateMe?: Maybe<{ readonly currentUser?: Maybe<{ readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } }> }> };
...
export type UpsertPlaylistMutation = { readonly upsertPlaylist?: Maybe<{ readonly playlist?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly publicType: PlaylistPublicTypeEnum, readonly isMine?: Maybe<boolean>, readonly createdAt: string, readonly updatedAt: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly items: ReadonlyArray<{ readonly trackNumber: number, readonly track: { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> } }> }> }> };
...
export type AlbumQuery = { readonly album?: Maybe<{ readonly id: string, readonly totalTracks: number, readonly name: string, readonly status: StatusEnum, readonly releaseDate: string, readonly recordLabel: string, readonly copyright: string, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicAlbum?: Maybe<{ readonly id: string, readonly appleMusicId: string }>, readonly itunesAlbum?: Maybe<{ readonly id: string, readonly appleMusicId: string }>, readonly tracks: ReadonlyArray<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> }> };
...
export type AlbumsQuery = { readonly items: ReadonlyArray<{ readonly id: string, readonly name: string, readonly status: StatusEnum, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicAlbum?: Maybe<{ readonly id: string }>, readonly itunesAlbum?: Maybe<{ readonly id: string }> }> };
...
export type ArtistQuery = { readonly artist?: Maybe<{ readonly id: string, readonly name: string, readonly status: StatusEnum, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> } }> };
...
export type ArtistsQuery = { readonly items: ReadonlyArray<{ readonly id: string, readonly name: string, readonly status: StatusEnum, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> } }> };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { readonly me: { readonly id: string, readonly name: string, readonly username: string, readonly registered: boolean, readonly publicInformations: ReadonlyArray<{ readonly id: string, readonly publicType: string }>, readonly role: { readonly id: string, readonly name: string, readonly description: string, readonly allowedActions: ReadonlyArray<string> }, readonly favorite: { readonly albumIds: ReadonlyArray<string>, readonly artistIds: ReadonlyArray<string>, readonly trackIds: ReadonlyArray<string>, readonly playlistIds: ReadonlyArray<string> } } };
...
export type PlaylistQuery = { readonly playlist?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly publicType: PlaylistPublicTypeEnum, readonly isMine?: Maybe<boolean>, readonly createdAt: string, readonly updatedAt: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly items: ReadonlyArray<{ readonly trackNumber: number, readonly track: { readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> } }> }> };
...
export type PlaylistsQuery = { readonly items: ReadonlyArray<{ readonly id: string, readonly name: string, readonly createdAt: string, readonly updatedAt: string, readonly author?: Maybe<{ readonly id: string, readonly name: string, readonly username: string }>, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> }> };
...
export type RadioQuery = { readonly radio?: Maybe<{ readonly id: string, readonly name: string, readonly description: string, readonly startDatetime?: Maybe<string>, readonly trackNumber: number, readonly durationMs: number, readonly isMine?: Maybe<boolean>, readonly tracks: ReadonlyArray<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }>, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> }> };
...
export type RadiosQuery = { readonly items: ReadonlyArray<{ readonly id: string, readonly name: string, readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> }> };
...
export type TrackQuery = { readonly track?: Maybe<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> };
...
export type TracksQuery = { readonly items: ReadonlyArray<{ readonly id: string, readonly isrc: string, readonly name: string, readonly discNumber: number, readonly trackNumber: number, readonly durationMs: number, readonly previewUrl?: Maybe<string>, readonly popularity: number, readonly artworkL: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly artworkM: { readonly url?: Maybe<string>, readonly width?: Maybe<number>, readonly height?: Maybe<number> }, readonly appleMusicTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>>, readonly itunesTracks?: Maybe<ReadonlyArray<{ readonly id: string, readonly name: string, readonly appleMusicId: string }>> }> };
